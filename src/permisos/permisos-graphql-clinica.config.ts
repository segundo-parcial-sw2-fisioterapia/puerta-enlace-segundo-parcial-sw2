...
export const PERMISOS_GRAPHQL_CLINICA: PermisoGraphql[] = [
  ...
  { operacion: 'crearPersonas', roles: ['administrador', 'recepcionista', 'fisioterapeuta'] },
  { operacion: 'editarPersona', roles: ['administrador', 'recepcionista', 'fisioterapeuta'] },
  ...
  { operacion: 'verEvaluacionInicial', roles: ['administrador', 'fisioterapeuta', 'recepcionista'] },
  { operacion: 'listarEvaluacionesPorPaciente', roles: ['administrador', 'fisioterapeuta', 'recepcionista'] },
  { operacion: 'crearEvaluacionesIniciales', roles: ['fisioterapeuta', 'administrador', 'director', 'recepcionista'] },
  { operacion: 'editarEvaluacionInicial', roles: ['fisioterapeuta', 'administrador', 'recepcionista'] },
  { operacion: 'eliminarEvaluacionInicial', roles: ['administrador'] },

  // --- Planes de Tratamiento ---
  { operacion: 'listarPlanesTratamientos', roles: ['administrador', 'fisioterapeuta', 'director', 'recepcionista'] },
  { operacion: 'verPlanTratamiento', roles: ['administrador', 'fisioterapeuta', 'director', 'recepcionista'] },
  { operacion: 'listarPlanesPorPaciente', roles: ['administrador', 'fisioterapeuta', 'director', 'recepcionista'] },
  { operacion: 'crearPlanesTratamientos', roles: ['fisioterapeuta', 'administrador', 'director', 'recepcionista'] },
  { operacion: 'editarPlanTratamiento', roles: ['fisioterapeuta', 'administrador', 'director', 'recepcionista'] },
  { operacion: 'eliminarPlanTratamiento', roles: ['administrador', 'director'] },
  ...
  { operacion: 'listarPlanesEjerciciosPorPaciente', roles: ['fisioterapeuta', 'paciente', 'administrador'] },
  ...
  // --- Sesiones Clínicas ---
  { operacion: 'listarSesiones', roles: ['administrador', 'fisioterapeuta', 'director', 'recepcionista', 'paciente'] },
  { operacion: 'verSesion', roles: ['administrador', 'fisioterapeuta', 'recepcionista', 'paciente'] },
  { operacion: 'crearSesiones', roles: ['administrador', 'fisioterapeuta'] },
  { operacion: 'listarSesionesPorPaciente', roles: ['administrador', 'fisioterapeuta', 'recepcionista', 'paciente'] },
  { operacion: 'listarSesionesPorPlan', roles: ['administrador', 'fisioterapeuta', 'recepcionista', 'paciente'] },
  { operacion: 'listarSesionesPorMensualidad', roles: ['administrador', 'fisioterapeuta', 'recepcionista', 'paciente'] },
  { operacion: 'listarSesionesPorEmpleado', roles: ['fisioterapeuta', 'administrador', 'recepcionista', 'paciente'] },
